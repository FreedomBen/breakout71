...
import {Ball, BallLike, Coin, colorString, GameState, PerkId, RunHistoryItem, RunParams, Upgrade,} from "./types";
import {isOptionOn, OptionId, options, toggleOption} from "./options";
